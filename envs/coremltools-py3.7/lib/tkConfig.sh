...
# installed.
TK_PREFIX='/Users/tonybove/opt/coremltools/envs/coremltools-py3.7'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/tonybove/opt/coremltools/envs/coremltools-py3.7'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/tonybove/opt/coremltools/envs/coremltools-py3.7/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/tonybove/opt/coremltools/envs/coremltools-py3.7/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/tonybove/opt/coremltools/envs/coremltools-py3.7/lib -ltkstub8.6'
...
TK_STUB_LIB_PATH='/Users/tonybove/opt/coremltools/envs/coremltools-py3.7/lib/libtkstub8.6.a'
